local ts = require("awesome-nvim-colorschemes.tokyonight.treesitter")
...
function M.invert_color(color)
  local hsluv = require("awesome-nvim-colorschemes.tokyonight.hsluv")
  if color ~= "NONE" then
...
function M.autocmds(config)
  vim.cmd([[augroup TokyoNight]])
  vim.cmd([[  autocmd!]])
  vim.cmd([[  autocmd ColorScheme * lua require("awesome-nvim-colorschemes.tokyonight.util").onColorScheme()]])
